    ...
    <div id="wrapper">
      ...
      >
        ...
        >
          ...
          <div class="sidebar-brand-text mx-3">پنل ادمین نویتکس</div>
        </a>
        ...
        <!-- Heading -->
        <div class="sidebar-heading">لیست کاربران</div>
        ...
        <li class="nav-item">
          ...
          >
            <div class="bg-white py-2 collapse-inner rounded">
              <a class="collapse-item" href="<?= site_url('admin/users') ;?> ">مشاهده لیست کاربران</a>
        ...
        <!-- Heading -->
        <div class="sidebar-heading">لیست کد معرف</div>
        ...
        <li class="nav-item">
          ...
          >
            <div class="bg-white py-2 collapse-inner rounded">
              <a class="collapse-item" href="<?= site_url('admin/codes') ;?> ">مشاهده کدهای معرف</a>
              <a class="collapse-item" href="<?= site_url('admin/code/create') ;?> ">افزودن کد معرف</a>
            </div>
          </div>
        </li>
