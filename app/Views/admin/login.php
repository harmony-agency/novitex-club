...
<head>
    ...
    <title>پنل ادمین باشگاه مشتریان نویتکس</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">پنل ادمین نویتکس</h1>
                                    </div>
                                    <form id="adminLogin" class="user" method="POST" action="javascript:void(0)">
